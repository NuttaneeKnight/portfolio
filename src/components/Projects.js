  ...
  const projects = [
    {
      ...
      description: "https://github.com/NuttaneeKnight/WeLoveMovies-Backend",
      imgUrl: projImg1,
    },
    {
                  ...
                  <Tab.Container id="projects-tabs" defaultActiveKey="first">
                    ...
                    >
                      ...
                      <Tab.Pane eventKey="second">
                        <p>
                          Learning Python 3 at the moment <br></br>Wait for the
                          future project!
                        </p>
                      </Tab.Pane>
                      <Tab.Pane eventKey="third">
                        <p>
                          Any suggestion on which project I should work on?{" "}
                          <br></br>Let me know below, would love to collaborate
                          with fellow coders!
                        </p>
                      </Tab.Pane>
                    </Tab.Content>
